...
let $wikicommons := concat("https://commons.wikimedia.org/wiki/Category:",replace($latin," ","_"))
let $images := for $li in doc($wikicommons)//li[@class="gallerybox"]
               return 
                  element illustration {
                     element thumb {$li//img/@src/string()},
                     element url {concat("https://commons.wikimedia.org",$li//a[@class="image"]/@href/string())},
                     element text {$li//p/text()}
                  }
